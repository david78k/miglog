...
<h2>Single host controller AIMD 8vms-r2 (<a href=../>../UP</a>)</h2>

<a href=8vms-r2.png><img src=8vms-r2.png></a>
<a href=8vms-r2.tiff><img src=8vms-r2.tiff></a>
<br />
...
<a href=8vms-r2.dstat>8vms-r2.dstat (network data file)</a>
<?php
$str = file_get_contents("8vms-r2.dstat");
echo "<pre>$str</pre>";
?>

<a href=8vms-r2.p>8vms-r2.p (gnuplot script file)</a>
<?php $str = file_get_contents ("8vms-r2.p");
echo "<pre>$str</pre>";
?>
