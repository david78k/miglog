...
<h2>Single host controller AIMD 10vms-r3 (<a href=../>../UP</a>)</h2>

<a href=10vms-r3.png><img src=10vms-r3.png></a>
<a href=10vms-r3.tiff><img src=10vms-r3.tiff></a>
<br />
...
<a href=10vms-r3.dstat>10vms-r3.dstat (network data file)</a>
<?php
$str = file_get_contents("10vms-r3.dstat");
echo "<pre>$str</pre>";
?>

<a href=10vms-r3.p>10vms-r3.p (gnuplot script file)</a>
<?php $str = file_get_contents ("10vms-r3.p");
echo "<pre>$str</pre>";
?>
