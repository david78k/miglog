...
<h2>Single host controller AIMD 8vms-r5 (<a href=../>../UP</a>)</h2>

<a href=8vms-r5.png><img src=8vms-r5.png></a>
<a href=8vms-r5.tiff><img src=8vms-r5.tiff></a>
<br />
...
<a href=8vms-r5.dstat>8vms-r5.dstat (network data file)</a>
<?php
$str = file_get_contents("8vms-r5.dstat");
echo "<pre>$str</pre>";
?>

<a href=8vms-r5.p>8vms-r5.p (gnuplot script file)</a>
<?php $str = file_get_contents ("8vms-r5.p");
echo "<pre>$str</pre>";
?>
