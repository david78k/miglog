...
<h2>Single host controller AIMD 6vms-r3 (<a href=../>../UP</a>)</h2>

<a href=6vms-r3.png><img src=6vms-r3.png></a>
<a href=6vms-r3.tiff><img src=6vms-r3.tiff></a>
<br />
...
<a href=6vms-r3.dstat>6vms-r3.dstat (network data file)</a>
<?php
$str = file_get_contents("6vms-r3.dstat");
echo "<pre>$str</pre>";
?>

<a href=6vms-r3.p>6vms-r3.p (gnuplot script file)</a>
<?php $str = file_get_contents ("6vms-r3.p");
echo "<pre>$str</pre>";
?>
