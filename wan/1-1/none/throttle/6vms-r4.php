...
<h2>Single host controller AIMD 6vms-r4 (<a href=../>../UP</a>)</h2>

<a href=6vms-r4.png><img src=6vms-r4.png></a>
<a href=6vms-r4.tiff><img src=6vms-r4.tiff></a>
<br />
...
<a href=6vms-r4.dstat>6vms-r4.dstat (network data file)</a>
<?php
$str = file_get_contents("6vms-r4.dstat");
echo "<pre>$str</pre>";
?>

<a href=6vms-r4.p>6vms-r4.p (gnuplot script file)</a>
<?php $str = file_get_contents ("6vms-r4.p");
echo "<pre>$str</pre>";
?>
