...
<h2>Single host controller AIMD 7vms-r1 (<a href=../>../UP</a>)</h2>

<a href=7vms-r1.png><img src=7vms-r1.png></a>
<a href=7vms-r1.tiff><img src=7vms-r1.tiff></a>
<br />
...
<a href=7vms-r1.dstat>7vms-r1.dstat (network data file)</a>
<?php
$str = file_get_contents("7vms-r1.dstat");
echo "<pre>$str</pre>";
?>

<a href=7vms-r1.p>7vms-r1.p (gnuplot script file)</a>
<?php $str = file_get_contents ("7vms-r1.p");
echo "<pre>$str</pre>";
?>
